...
console.log(googleMapsApiKey, '111122')
...
// };
const BookingModal = ({ visible, onClose }) => {
  const [productDim, setProductDim] = useState('');
        ...
        <View style={styles.modalContent} onStartShouldSetResponder={() => true}>
          ...
          />
           <TextInput
            ...
            value={productDim}
            onChangeText={setProductDim}
          />
          <TextInput
            style={styles.input}
            placeholder="Product Weight"
            value={proWeight}
            onChangeText={setProWeight}
          />

          <TextInput
            style={styles.input}
            placeholder="Reciever contact number"
          ...
          <View style={styles.checkboxContainer}>
            <Checkbox
              ...
              onValueChange={setHandleWithCare}
            />
            <Text style={styles.checkboxLabel}>Handle with Care</Text>
          </View>

          <Button title="Confirm Delivery" onPress={onClose} />
        </View>
      </Pressable>
    </Modal>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {dropLocation && <Marker coordinate={dropLocation} pinColor="green" title="Delivery Location" />}
